...
React JS is a JavaScript library for building user interfaces. React is used for development of large applications where data changes over time.React is not a framework so it gives more flexibility for development.

1. Describe component state.

State is an object that determines how the React component renders and behaves.
...
Side effect is an application state change that happens outside of the called function. We should use React hooks to sync effects in a React component.
